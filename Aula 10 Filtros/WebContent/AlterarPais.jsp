			...
			<div class="row">
				<div class="form-group col-md-12">
					<label for="nome">Nome</label> <input type="text"
						...
						maxlength="100" placeholder="Digite o Nome do Pais Desejado"
						value="${pais.nome }">
				</div>
			</div>
			<div class="row">
				<div class="form-group col-md-6">
					<label for="populacao">Populacao</label> <input type="tel"
						class="form-control" name="populacao" id="populacao" maxlength="15"
						value="${pais.populacao }">
				</div>

				<div class="form-group col-md-6">
					<label for="area">Area</label> <input type="area"
						class="form-control" name="area" id="area" required
						maxlength="60" placeholder="area obrigatório"
						value="${pais.area }">
				</div>
			</div>
			<hr />
